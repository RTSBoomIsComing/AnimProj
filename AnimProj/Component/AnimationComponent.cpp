...
pa::AnimationComponent::AnimationComponent(ID3D11Device* device, const Skeleton& skeleton)
	: _skeleton(&skeleton)
{
...
pa::AnimationComponent::~AnimationComponent() = default;

void pa::AnimationComponent::update(Character & owner, float deltaTime)
{
...
pa::AnimationPlayer& pa::AnimationComponent::getAnimationPlayer(AnimPlayerIndex index)
{
